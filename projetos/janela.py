...
txt_obs = Text(fr_contato, width=30, height=4,
               font=('Ebrima', 12))
txt_nome1 = Entry(lfr_pesquisar, width=20,
                  font=('Ebrima, 12'), justify='left')
...
treev = ttk.Treeview(fr_contato, columns=colunas,
                     show='headings', height=14, padding=(1, 1))
...
lfr_pesquisar.grid(column=0, row=5, columnspan=3, padx=(1, 0),
                   pady=(20, 2), sticky='w')
lfr_editar.grid(column=2, row=5, columnspan=5, padx=(5, 0),
                pady=(20, 2), ipady=5, sticky='n', ipadx=0)
fr_btn_pesquisar.grid(column=3, row=0, rowspan=2, padx=10,
                      pady=(0, 5), ipady=5, sticky='nsew')  # **
...
txt_obs.grid(column=5, row=2, padx=(5, 0),
             pady=(20, 2), sticky='wn', rowspan=3)
txt_nome1.grid(column=0, row=1, padx=2, pady=5, sticky='nsew')

# *Botões:
# btn.grid(column=0, row=0, ipadx=30, padx=2, pady=2, sticky='n')
btn_pesquisar.pack(anchor="center",
                   fill='x', side='left')    # grid(column=3, row=0, padx=10, pady=2, sticky='n') # **
...
scrollbarv.grid(row=0, column=6, sticky='n')
